...
if (operationAns.operationAns === "check Balance") {
    ...
    else if (operationAns.operationAns ===
    "withdraw") {
    ...
    if (withdrawMethod.withdrawMethod ===
    "fastCash") {
    let fastCashAmount = await
    inquirer.prompt([
    {
    name: "fastCashAmount",
